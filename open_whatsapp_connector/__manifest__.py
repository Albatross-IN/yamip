{
    ...
    'version': '19.0.96.0.0',
    'images': [
        'static/description/open_whatsapp_demo.gif',
        ...
        'static/description/screenshots/read_receipts_blue_ticks.png',
        'static/description/screenshots/whatsapp_in_place_chatter.png',
        'static/description/screenshots/whatsapp_discuss_inbox.png',
        'static/description/screenshots/helpdesk_whatsapp_bridge.png',
        ...
        'static/description/screenshots/conversations_kanban_assignee.png',
        'static/description/screenshots/my_whatsapp_self_service.png',
        'static/description/screenshots/cloud_api_account.png',
    ],
    'description': """
...
- Campaigns with rendered templates, polls, sync send for small lists, bus-driven
  form refresh
- Drip campaigns: walk res.partner a batch per cron tick (default 1 / 5 min),
  filtered by a saved domain, with per-contact variable rendering; the run
  self-terminates and switches its own scheduled action off
...
- Daily partner-avatar refresh from WhatsApp profile pictures
    ...
    'data': [
        ...
        'security/ir_model_access_account.xml',
        ...
        'wizard/owa_reply_account_wizard_views.xml',
        ...
        'wizard/owa_import_wizard_views.xml',
        'wizard/owa_cloud_wizard_views.xml',
        'views/owa_import_job_views.xml',
        'views/owa_message_views.xml',
        'views/owa_account_views.xml',
        'views/owa_my_whatsapp_views.xml',
        ...
        'views/owa_conversation_views.xml',
